...
export type FlowsElementaryCategory =
  ...
  | { '@level'?: '1'; '@catId'?: '2.2'; '#text'?: 'Resources from water' }
  | {
      '@level'?: '2';
      '@catId'?: '2.2.1';
  ...
  | { '@level'?: '1'; '@catId'?: '2.3'; '#text'?: 'Resources from air' }
  | {
      '@level'?: '2';
      '@catId'?: '2.3.1';
  ...
  | { '@level'?: '1'; '@catId'?: '2.4'; '#text'?: 'Resources from biosphere' }
  | {
      '@level'?: '2';
      '@catId'?: '2.4.1';
